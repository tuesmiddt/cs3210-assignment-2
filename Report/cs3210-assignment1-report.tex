...
\begin{itemize}
  ...
  \item The completion flag must to be marked as \mintinline{C}{volatile} ensure that Unified Memory optimisations do not cause the variable to be migrated into shared/local memory.
